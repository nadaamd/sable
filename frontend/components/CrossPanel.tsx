    ...
    <div className="panel">
      ...
      <div className="grid grid-cols-2 gap-px bg-[var(--line)]">
        <div className="bg-[var(--panel)] px-3 py-4">
          <div className="panel-label">Clearing price</div>
          <div className="mt-1 text-4xl" style={{ color: batch.cleared ? "var(--accent)" : "var(--seal)" }}>
            {batch.cleared ? (batch.clearingPrice === 0 ? "no cross" : batch.clearingPrice) : "—"}
          </div>
        </div>
        <div className="bg-[var(--panel)] px-3 py-4">
          <div className="panel-label">Matched volume</div>
          <div className="mt-1 text-4xl" style={{ color: batch.cleared ? "var(--ink)" : "var(--seal)" }}>
      ...
      <div className="border-t border-[var(--line)] px-3 py-3">
        <div className="mb-2 panel-label">Price grid</div>
